goog.provide( 'who.engine.ChromiumOrAndroidWebView.hasChromeObject' );
goog.provide( 'who.engine.ChromiumOrAndroidWebView.CHROMIUM_IMPLEMENT_VERSION' );

goog.provide( 'who.engine.ChromiumOrAndroidWebView.ANDROID_WEBVIEW_IMPLEMENT_VERSION' );
goog.provide( 'who.engine.ChromiumOrAndroidWebView.maybeAOSP' );
goog.provide( 'who.engine.ChromiumOrAndroidWebView.maybeChromeWebView' );

goog.provide( 'who.engine.ChromiumOrAndroidWebView.is' );
goog.provide( 'who.engine.ChromiumOrAndroidWebView.detect' );

goog.require( 'who.base' );
goog.require( 'who.engine.Trident.is' );
goog.require( 'who.engine.EdgeHTML.is' );
goog.require( 'who.brand.Chrome.NAVIGATOR_VERSION' );
goog.require( 'who.brand.Iron.NAVIGATOR_VERSION' );
 ...
 * @private
 * @const {boolean} */
var _hasChromeObject =
    !who.engine.EdgeHTML.is() && // EdgeHTML has .chrome
    !!(
 ...
 * @const {boolean}
 */
who.engine.ChromiumOrAndroidWebView.hasChromeObject = _hasChromeObject;

/**
 * TODO Android 標準ブラウザの Chrome WebView + PC site requested では Chrome/11 とあり得ない値が入っている
 * @const {number}
 */
who.engine.ChromiumOrAndroidWebView.CHROMIUM_IMPLEMENT_VERSION = 0;
 ...
 * @const {number|string} */
who.engine.ChromiumOrAndroidWebView.ANDROID_WEBVIEW_IMPLEMENT_VERSION =
...
who.engine.ChromiumOrAndroidWebView.detect = function(){
    if( who.engine.ChromiumOrAndroidWebView.is() ){
        ...
        if( isAndroid && who.engine.ChromiumOrAndroidWebView.maybeAOSP ){
            p_setEngine( ENGINE.Android_WebView, who.engine.ChromiumOrAndroidWebView.ANDROID_WEBVIEW_IMPLEMENT_VERSION );
