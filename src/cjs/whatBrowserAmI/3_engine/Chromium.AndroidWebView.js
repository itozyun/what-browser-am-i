 ...
 * @const {boolean}
 */
whatBrowserAmI.engine.ChromiumOrAndroidWebView.hasChromeObject = _hasChromeObject;
 ...
 * @const {boolean}
 */
whatBrowserAmI.engine.ChromiumOrAndroidWebView.maybeAOSP = _hasChromeObject && p_numberWebKit <= 534.3;
