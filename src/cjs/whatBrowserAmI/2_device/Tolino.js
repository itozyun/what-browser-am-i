goog.provide( 'whatBrowserAmI.device.Tolino.is' );
goog.provide( 'whatBrowserAmI.device.Tolino.detect' );
...
/** @return {boolean} */
whatBrowserAmI.device.Tolino.is = function(){
    return false;
};

/** @return {boolean|void} */
whatBrowserAmI.device.Tolino.detect = function(){
    if( whatBrowserAmI.device.Tolino.is() ){
