goog.provide( 'whatBrowserAmI.device.FireTV.FIRE_OS_VERSION' );
...
/** @const {number|void} */
whatBrowserAmI.device.FireTV.FIRE_OS_VERSION = fireOSVersionAndFireTVReleased && fireOSVersionAndFireTVReleased[ 0 ];
