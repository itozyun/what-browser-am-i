goog.provide( 'whatBrowserAmI.device.KindleFire.FIRE_OS_VERSION' );
...
var fireOSVersionAndKindleFireGeneration =
    ...
    p_hasSubstring( p_strUserAgent, 'KFSAWI' ) ? [ ( 5 <= parseFloat( whatBrowserAmI.engine.ChromiumOrAndroidWebView.ANDROID_WEBVIEW_IMPLEMENT_VERSION ) ? 5 : 4 ), 4 ] :
