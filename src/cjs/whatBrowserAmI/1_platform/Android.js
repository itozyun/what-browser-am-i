...
goog.require( 'whatBrowserAmI.device.isEinkAndroid' );
...
var _isAndroidWithFennec =
        ...
        && whatBrowserAmI.engine.Gecko.is();

/**
 * @private
 * @const {boolean} */
var _isAndroidWithPresto = _hasAndroidString && whatBrowserAmI.engine.Presto.is();
...
var _isAndroidAccordingToClues =
        whatBrowserAmI.brand.Lunascape.maybeLunascapeOnAndroid ||
        whatBrowserAmI.brand.Sleipnir.isOnAndroid ||
        whatBrowserAmI.brand.Yahoo.isOnAndroid || _isChromiumFamilyOnAndroidPcSiteRequested || whatBrowserAmI.device.isEinkAndroid();

/** @const {string} */
whatBrowserAmI.platform.Android.NAVIGATOR_VERSION = _versionAndroid;
