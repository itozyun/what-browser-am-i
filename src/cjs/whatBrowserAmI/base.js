...
goog.provide( 'whatBrowserAmI.base.finalizeDeviceType' );
goog.provide( 'whatBrowserAmI.base.finalizeEngine' );
goog.provide( 'whatBrowserAmI.base.finalizeBrand' );
goog.provide( 'whatBrowserAmI.base.finalizePcSiteRequested' );
...
whatBrowserAmI.base.finalizeDeviceType = function(){
    if( p_deviceType ){
...
whatBrowserAmI.base.finalizePcSiteRequested = function(){
