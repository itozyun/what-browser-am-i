    ...
    if( obj === window ){
        ...
        do {
            ...
            for( i = 0, l = allKeys.length; i < l; ++i ){
                ...
                // alert( property )
                if( isClassName( property ) && core.isFunction( obj[ property ] ) ){
...
function collect( properties, obj, property, nonenum ){
    ...
    } else if( core.isFunction( obj ) && ( property === 'arguments' || property === 'callee' || property === 'caller' ) ){
        if( !functionProperties[ property ] ){
            properties.push( property, [ property ] );
            functionProperties[ property ] = true;
        };
        ++skippedPropertiesCount;
    } else if( core.isFunction( obj ) && ( property === 'name' || property === 'length' ) ){
        ++skippedPropertiesCount;
    } else {
